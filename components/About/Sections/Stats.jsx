const Stats = () => {
  return (
    <div className="grid grid-cols-1 divide-gray-400 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x text-black bg-secondary">
      <div data-aos="zoom-in" className="text-center p-8">
